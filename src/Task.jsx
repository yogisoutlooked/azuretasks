...
function task() {
  ...
  return (
    <div className="px-2 ">
      <div className="font-bold font-poppins text-[10px] text-[#065BC9] ml-2 ">
        Open Booking: 12
      </div>
      ...
      <Box sx={{ height: "150px", marginTop: 1, width: "100%" }}>
        ...
        <Card
          ...
          sx={{ borderRadius: "16px", height: "130px", textAlign: "left" }}>
            <div className=" bg-[#F2F3F8] relative h-60 w-[140px] rounded-r-[80px]">
          <div className="m-3 w-[330px] absolute " >
      ...
      <Box sx={{ height: "150px", marginTop: 1, width: "100%" }}>
        ...
        <Card
          ...
          <div className="m-3 w-[330px] absolute " >
            ...
            <div className="w-90 h-3 mt-2 bg-gray-200 rounded-full dark:bg-gray-700 ">
              <div
                className="bg-[#FFA91F] text-[8px] font-bold h-3 text-white text-right align-centre  leading-none rounded-full"
                Style="width: 45% " 
              >
                {" "}
                <span className="inline-block align-middle">75%</span>
 ...
 <Box sx={{ height: "150px", marginTop: 1, width: "100%" }}>
        ...
        <Card
          ...
          <div className="m-3 w-[330px] absolute " >
            ...
            <div className="w-90 h-3 mt-2 bg-gray-200 rounded-full dark:bg-gray-700 ">
              <div
                className="bg-[#FF0000] text-[8px] font-bold h-3 text-white text-right align-centre  leading-none rounded-full"
                Style="width: 45% " 
              >
                {" "}
                <span className="inline-block align-middle">75%</span>
